...
Object.assign(CHAR_INFO, {
  "不": "bù · ne pas", "两": "liǎng · deux", "为": "wèi/wéi · pour, faire", "久": "jiǔ · longtemps", "乐": "lè/yuè · joie, musique", "也": "yě · aussi", "事": "shì · affaire, chose", "井": "jǐng · puits; dans Wangfujing", "亮": "liàng · lumineux, joli", "什": "shén/shí · quoi; élément de 什么", "今": "jīn · aujourd'hui, présent", "以": "yǐ · avec, au moyen de, depuis", "件": "jiàn · affaire; classificateur vêtement", "份": "fèn · portion, exemplaire", "但": "dàn · mais", "位": "wèi · place; classificateur poli", "住": "zhù · habiter", "使": "shǐ · envoyer, utiliser; ambassade", "信": "xìn · confiance, lettre", "候": "hòu · moment; dans 时候", "傅": "fu/fù · maître; dans 师傅", "先": "xiān · d'abord", "光": "guāng · lumière", "克": "kè · gramme; syllabe de noms étrangers", "全": "quán · tout, complet", "八": "bā · huit", "关": "guān · fermer, passer une barrière",
  "再": "zài · encore, puis", "冰": "bīng · glace, froid", "几": "jǐ · combien, quelques", "分": "fēn/fèn · minute, diviser, portion", "利": "lì · avantage, bénéfice", "别": "bié · autre; ne pas", "刹": "chà · temple; dans 什刹海", "力": "lì · force", "包": "bāo · paquet, sac, baozi", "匹": "pǐ · classificateur; syllabe de noms étrangers", "医": "yī · médecine", "午": "wǔ · midi", "博": "bó · vaste; musée", "厅": "tīng · salle", "压": "yā · pression, presser", "参": "cān · participer, visiter", "友": "yǒu · ami", "双": "shuāng · paire", "发": "fā · émettre, partir", "叫": "jiào · appeler, commander", "台": "tái · comptoir, plateforme", "叶": "yè · feuille", "号": "hào · numéro", "司": "sī · gérer; entreprise", "合": "hé · convenir, unir", "同": "tóng · même, ensemble", "名": "míng · nom, célèbre",
  "周": "zhōu · semaine, cycle", "味": "wèi · goût", "咖": "kā · café, transcription", "品": "pǐn · produit, objet", "商": "shāng · commerce", "啡": "fēi · café, transcription", "喜": "xǐ · aimer, joie", "回": "huí · revenir", "址": "zhǐ · adresse", "坛": "tán · autel, temple", "墙": "qiáng · mur", "外": "wài · extérieur", "天": "tiān · ciel, jour", "太": "tài · trop, très", "失": "shī · perdre", "头": "tóu · tête, bout", "套": "tào · ensemble, housse", "奥": "ào · profond; transcription olympique", "字": "zì · caractère, mot écrit", "安": "ān · paix, sécurité", "完": "wán · finir", "定": "dìng · fixer, réserver", "寓": "yù · résidence; appartement", "对": "duì · envers, correct", "尝": "cháng · goûter", "就": "jiù · alors, justement", "尽": "jìn · fin, extrémité", "局": "jú · bureau, office",
  "展": "zhǎn · exposition, déployer", "屯": "tún · village; dans 三里屯", "峰": "fēng · pic, pointe", "巢": "cháo · nid", "巷": "xiàng · ruelle", "师": "shī · maître, enseignant", "带": "dài · apporter, ceinture", "帮": "bāng · aider", "常": "cháng · souvent, ordinaire", "广": "guǎng · large, vaste", "府": "fǔ · résidence officielle", "建": "jiàn · construire", "张": "zhāng · ouvrir; classificateur objet plat", "影": "yǐng · image, film", "待": "dài · attendre, traiter", "很": "hěn · très", "忘": "wàng · oublier", "念": "niàn · penser à, souvenir", "思": "si/sī · pensée, sens", "急": "jí · urgent, anxieux", "总": "zǒng · toujours, total", "息": "xi · souffle; information", "情": "qíng · sentiment, situation", "惊": "jīng · surprise", "成": "chéng · devenir, réussir", "房": "fáng · pièce, maison", "所": "suǒ · lieu; établissement", "手": "shǒu · main",
  "打": "dǎ · frapper; appeler/prendre", "把": "bǎ · poignée; particule 把", "排": "pái · rangée, faire la queue", "推": "tuī · pousser, recommander", "提": "tí · porter, mentionner", "故": "gù · ancien, cause; Cité interdite", "敏": "mǐn · sensible", "散": "sàn · se disperser, se promener", "文": "wén · langue, culture", "料": "liào · matière, boisson", "旅": "lǚ · voyage", "早": "zǎo · tôt, matin", "时": "shí · temps, moment", "明": "míng · clair; demain", "是": "shì · être", "晚": "wǎn · soir, tard", "景": "jǐng · paysage, site", "最": "zuì · le plus", "有": "yǒu · avoir, il y a", "朋": "péng · ami", "服": "fú · vêtement, service", "期": "qī · période, attendre", "末": "mò · fin", "本": "běn · racine; classificateur livre", "机": "jī · machine, occasion", "条": "tiáo · bande; classificateur route", "杯": "bēi · verre, tasse", "林": "lín · forêt",
  "果": "guǒ · fruit, résultat", "树": "shù · arbre", "校": "xiào · école", "样": "yàng · apparence, manière", "椒": "jiāo · poivre, piment", "概": "gài · général; environ", "次": "cì · fois", "欢": "huān · joie, aimer", "步": "bù · pas, marche", "比": "bǐ · comparer", "没": "méi · ne pas avoir", "油": "yóu · huile, gras", "洗": "xǐ · laver", "派": "pài · envoyer, poste", "浆": "jiāng · liquide épais", "消": "xiāo · disparaître; nouvelle", "淡": "dàn · léger, fade", "清": "qīng · clair, léger", "温": "wēn · tiède, température", "漂": "piào · joli; flotter", "火": "huǒ · feu", "炒": "chǎo · faire sauter", "点": "diǎn · point, un peu, commander", "烤": "kǎo · rôtir", "热": "rè · chaud", "然": "rán · ainsi; dans 然后", "爬": "pá · grimper", "物": "wù · chose, objet", "特": "tè · spécial", "王": "wáng · roi",
  "瓶": "píng · bouteille", "电": "diàn · électricité", "直": "zhí · droit, direct", "着": "zhe/zháo · aspect continu; anxieux dans 着急", "知": "zhī · savoir", "碗": "wǎn · bol", "社": "shè · communauté", "秋": "qiū · automne", "第": "dì · préfixe ordinal", "等": "děng · attendre", "筑": "zhù · construire; architecture", "素": "sù · végétarien, simple", "紧": "jǐn · serré, nerveux", "纪": "jì · souvenir, discipline", "练": "liàn · pratiquer", "结": "jié · nouer, régler", "网": "wǎng · filet, internet", "耐": "nài · résister à", "胡": "hú · barbe; hutong", "舒": "shū · confortable", "船": "chuán · bateau", "花": "huā · fleur, cacahuète", "荐": "jiàn · recommander", "药": "yào · médicament", "落": "luò · tomber; sentiment de vide", "行": "xíng/háng · aller; banque/ligne", "见": "jiàn · voir", "观": "guān · observer, visiter", "览": "lǎn · regarder, exposition",
  "觉": "jué · sentir, penser", "让": "ràng · laisser, faire que", "讶": "yà · surprise", "话": "huà · parole", "谢": "xiè · remercier", "账": "zhàng · compte, addition", "起": "qǐ · se lever; depuis", "超": "chāo · super, dépasser", "越": "yuè · de plus en plus", "跟": "gēn · avec, suivre", "较": "jiào · comparer, relativement", "近": "jìn · proche", "还": "hái · encore", "迟": "chí · tard", "迷": "mí · se perdre, fasciner", "适": "shì · convenir", "逛": "guàng · flâner", "道": "dào · voie; classificateur plat", "避": "bì · éviter", "邮": "yóu · postal", "酒": "jiǔ · alcool, hôtel", "钟": "zhōng · horloge, minute", "银": "yín · argent métal; banque", "错": "cuò · erreur", "锣": "luó · gong", "长": "cháng/zhǎng · long, grandir", "间": "jiān · pièce, intervalle", "闹": "nào · animé, bruyant", "队": "duì · file, équipe", "附": "fù · près de, attacher",
  "难": "nán · difficile", "雍": "yōng · harmonie; nom de lieu", "雨": "yǔ · pluie", "雪": "xuě · neige", "鞋": "xié · chaussure", "音": "yīn · son, musique", "预": "yù · à l'avance", "颐": "yí · entretenir; nom du Palais d'Été", "食": "shí · nourriture", "餐": "cān · repas", "饮": "yǐn · boire, boisson", "馅": "xiàn · farce", "香": "xiāng · parfumé; nom de lieu", "马": "mǎ · cheval; dans 马路 route/rue", "骑": "qí · monter, faire du vélo", "鲜": "xiān · frais", "鸟": "niǎo · oiseau", "鸭": "yā · canard", "鼓": "gǔ · tambour; dans 南锣鼓巷"
});
...
function charInfo(char) {
  const examples = sourceData()
    ...
    .map((item) => item.hanzi)
    .join(" / ");
  const base = CHAR_INFO[char] || fallbackCharInfo(char);
  return examples ? `${base} · exemple: ${examples}` : base;
}

function fallbackCharInfo(char) {
  const related = [...VOCAB_DATA, ...DATA]
    .filter((item) => item.hanzi.includes(char) || item.answer.includes(char))
    .slice(0, 3)
    .map((item) => `${item.hanzi} ${item.pinyin}`);
  if (related.length) {
    return `entrée à préciser · attesté dans: ${related.join(" / ")}`;
  }
  return "entrée à préciser · caractère absent du corpus actuel";
}
